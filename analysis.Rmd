...
#setwd("/Users/jorit/Library/Mobile Documents/com~apple~CloudDocs/Dokumente/HSLU/Semester_01/R_Bootcamp/Group_Work/R_Bootcamp")
...
```{r}
# Histogram Vegan & Vegetarian Restaurants by State
par(mfrow = c(1, 2))

hist(restaurants$province, main = "Vegan & Vegetarian Offers by State", xlab = "province")
```
