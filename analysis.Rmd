...
packages <- c("dplyr","readxl", "curl", "ggplot2", "ggrepel", "maps", "plotly", "stringr", "tm", "wordcloud2", "tidyverse", "RColorBrewer", "ggwordcloud", "viridis", "bookdown")
...
With only a small sample size of 211 restaurants with 10000 menu listings provided by @datafiniti2018, this study cannot make a significant prediction of the number of vegetarian restaurants in a zip code.

Nevertheless, this paper still gives some insights in regards to @mpsc2020.
