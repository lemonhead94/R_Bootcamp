...
packages <- c("dplyr","readxl", "curl", "ggplot2", "ggrepel", "maps", "plotly", "stringr", "tm", "wordcloud2", "tidyverse", "RColorBrewer", "ggwordcloud", "viridis")
...
```
### Vegetarian and Vegan Cuisines with ggplot since wordcloud2 can not be rendered into pdf...
